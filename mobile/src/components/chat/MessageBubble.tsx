...
const styles = StyleSheet.create({
  ...
  assistantBubble: { backgroundColor: colors.surfaceElevated, borderWidth: 1, borderColor: colors.border, borderBottomLeftRadius: borderRadius.xs },
  userText: { color: "#ffffff", fontSize: typography.size.base, lineHeight: typography.size.base * 1.5 },
